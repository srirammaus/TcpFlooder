...
$con = mysqli_connect("localhost:3306", "root", "password", "iinfo2") or  die("connection failed".mysqli_errno($con));
...
--------------*/
//$key=1;
$user_registration_query="insert into student (fullname,email,password,class,school) values ('$fullname','$email','$password','$class','$school');";
    ...
    <ul style="list-style-type:none; font-size: 15px">
         <li>
           <a  href="#0" style="bottom:0;">
               <i class="fa fa-envelope" style=" color:#8085e1"></i><em>&nbsp;&nbsp;&nbsp;<?php echo ($email); ?></em>
           </a>
        </li>
        <li>
           <a  href="#0" style="bottom:0;">
        ...
        <li>
           <a  href="#0" style="bottom:0;">
              <i class="fa fa-address-book" style=" color:#8085e1"></i><em>&nbsp;&nbsp;&nbsp;Class 12</em>
           </a>
        </li>
        <li>
           <a href="#0" style="bottom:0;">
